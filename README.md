...
if __name__ == "__main__":
    ...
    expression_field = Entry(gui, textvariable=equation,justify='right',font = "Helvetica 10 bold")
 
    # grid method is used for placing
    # the widgets at respective positions
    # in table like structure .
    expression_field.grid(columnspan=4, ipadx=50,ipady=20,)
    ...
    clear = Button(gui, text='CE', fg='white', bg='grey',
    ...
    Quit= Button(gui, text='Qiut', fg='white', bg='red',command=quit, height=2, width=10)
